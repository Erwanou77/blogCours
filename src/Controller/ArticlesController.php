...
class ArticlesController extends AbstractController
{
    ...
    #[Route('/your/articles', name: 'app_articles_allarticlesuser')]
    public function allArticlesUser(ArticlesRepository $articlesRepository): Response
    {
        return $this->render('articles/allarticles.html.twig', [
            'articles' => $articlesRepository->findAllArticlesByUser($this->getUser()),
        ]);
    }
}
